...
# GLobus driver is a straight copy of the FileSystem driver.
...
module BrowseEverything
  module Driver
    class Globus < Base
      ...
      def validate_config
        raise BrowseEverything::InitializationError, 'Globus driver requires a :home argument' if config[:home].blank?
      end
